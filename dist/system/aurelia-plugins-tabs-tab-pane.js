System.register(['aurelia-templating'], function (_export, _context) {
  ...
  var bindable, containerless, customElement;
  return {
    ...
    execute: function () {
      ...
      let TabPane = (_dec = containerless(), _dec2 = customElement('aup-tab-pane'), _dec(_class = _dec2(_class = (_class2 = class TabPane {
        constructor() {
